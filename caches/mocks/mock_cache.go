...
// Source: github.com/ArthurHlt/rparth/caches (interfaces: Cache)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_cache.go -package=mocks . Cache
//
...
import (
	...
	models "github.com/ArthurHlt/rparth/models"
...
func (m *MockCache) Get(key string) (*models.CacheData, bool) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", key)
	ret0, _ := ret[0].(*models.CacheData)
	ret1, _ := ret[1].(bool)
	return ret0, ret1
}
...
func (m *MockCache) Set(key string, data *models.CacheData) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Set", key, data)
}

// Set indicates an expected call of Set.
func (mr *MockCacheMockRecorder) Set(key, data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
